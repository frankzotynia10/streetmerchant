...
const store = {
  ...
  maxPrice: {
    series: {
      ...
      // optimus blocks
      'silver-nickel': envOrNumber(process.env.MAX_PRICE_SERIES_SILVER_NICKEL, 300),
      'silver-copper': envOrNumber(process.env.MAX_PRICE_SERIES_SILVER_COPPER, 300),
      'black-nickel': envOrNumber(process.env.MAX_PRICE_SERIES_BLACK_NICKEL, 300),
      'black-copper': envOrNumber(process.env.MAX_PRICE_SERIES_BLACK_COPPER, 300),
    },
  },
