...
const notifications = {
  ...
  discord: {
    ...
    notifyGroupSeries: {
      ...
      'm1-accessories': envOrArray(process.env.DISCORD_NOTIFY_GROUP_BLACK_COPPER),
      'm2-accessories': envOrArray(process.env.DISCORD_NOTIFY_GROUP_BLACK_COPPER),
    },
...
const store = {
  ...
  maxPrice: {
    series: {
      ...
      'm1-accessories': envOrNumber(process.env.MAX_PRICE_SERIES_BLACK_COPPER),
      'm2-accessories': envOrNumber(process.env.MAX_PRICE_SERIES_BLACK_COPPER),
    },
  },
