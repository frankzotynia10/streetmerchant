...
const notifications = {
  ...
  discord: {
    ...
    notifyGroupSeries: {
      ...
      'signature-v3-silver-nickel': envOrArray(process.env.DISCORD_NOTIFY_GROUP_SILVER_NICKEL),
      'signature-v3-silver-copper': envOrArray(process.env.DISCORD_NOTIFY_GROUP_SILVER_COPPER),
      'signature-v3-black-nickel': envOrArray(process.env.DISCORD_NOTIFY_GROUP_BLACK_NICKEL),
      'signature-v3-black-copper': envOrArray(process.env.DISCORD_NOTIFY_GROUP_BLACK_COPPER),
      'foundation-silver-nickel': envOrArray(process.env.DISCORD_NOTIFY_GROUP_SILVER_NICKEL),
      'foundation-silver-copper': envOrArray(process.env.DISCORD_NOTIFY_GROUP_SILVER_COPPER),
      'foundation-black-nickel': envOrArray(process.env.DISCORD_NOTIFY_GROUP_BLACK_NICKEL),
      'foundation-black-copper': envOrArray(process.env.DISCORD_NOTIFY_GROUP_BLACK_COPPER),
      'flex-silver': envOrArray(process.env.DISCORD_NOTIFY_GROUP_BLACK_COPPER),
      'm2-accessories': envOrArray(process.env.DISCORD_NOTIFY_GROUP_m2_accessories),
      'radiator': envOrArray(process.env.DISCORD_NOTIFY_GROUP_radiator),
      'reservoir': envOrArray(process.env.DISCORD_NOTIFY_GROUP_reservoir),
      'accessory': envOrArray(process.env.DISCORD_NOTIFY_GROUP_accessory),
    },
...
const store = {
  ...
  maxPrice: {
    series: {
      ...
      'signature-v3-silver-nickel': envOrNumber(process.env.MAX_PRICE_SERIES_SILVER_NICKEL),
      'signature-v3-silver-copper': envOrNumber(process.env.MAX_PRICE_SERIES_SILVER_COPPER),
      'signature-v3-black-nickel': envOrNumber(process.env.MAX_PRICE_SERIES_BLACK_NICKEL),
      'signature-v3-black-copper': envOrNumber(process.env.MAX_PRICE_SERIES_BLACK_COPPER),
      'foundation-silver-nickel': envOrNumber(process.env.MAX_PRICE_SERIES_SILVER_NICKEL),
      'foundation-silver-copper': envOrNumber(process.env.MAX_PRICE_SERIES_SILVER_COPPER),
      'foundation-black-nickel': envOrNumber(process.env.MAX_PRICE_SERIES_BLACK_NICKEL),
      'foundation-black-copper': envOrNumber(process.env.MAX_PRICE_SERIES_BLACK_COPPER),
      'flex-silver': envOrNumber(process.env.MAX_PRICE_SERIES_BLACK_COPPER),
      'm2-accessories': envOrNumber(process.env.MAX_PRICE_SERIES_m2_accessories),
      'radiator': envOrNumber(process.env.MAX_PRICE_SERIES_radiator),
      'reservoir': envOrNumber(process.env.MAX_PRICE_SERIES_reservoir),
      'accessory': envOrNumber(process.env.MAX_PRICE_SERIES_accessory),
    },
  },
